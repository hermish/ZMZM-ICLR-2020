...
while true
    ...
    %
%    NB: (Ju) calls tCG_CUR will check for possible presence of negative curvature
%    when the gradient is small; if present, the negative curvature direction used as 
%    the first search direction in conjugate gradient 
   
    
    [eta, Heta, numit, stop_inner] = ...
                tCG_CUR(problem, x, fgradx, eta, Delta, options, storedb, key);
